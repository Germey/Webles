...
<?if($page>1){echo "<a href='search2.php?page=".$first."&keyword=".$keyword."&shenhe=".$shenhe."&classid=".$classid."'>"?><font face="Webdings">9</font></a>&nbsp;<?echo "<a href='search2.php?page=".$prev."&keyword=".$keyword."&shenhe=".$shenhe."&classid=".$classid."'>"?><font face="Webdings">7</font></a><?}else{?><font face="Webdings">9</font>&nbsp;<font face="Webdings">7</font><?}?>
...
{ 
$pagetitle=$pagetitle." "."["."<a href='search2.php?page=".$j."&keyword=".$keyword."&shenhe=".$shenhe."&classid=".$classid."'>".$j."</a>"."]" ;
}
}
