...
<tr><td width=30><img src=images/admin_top_close.gif></td><td style="font-weight:800;color:white"> 编辑网站标题</td></tr>
</table>
	
<?
$id=$_GET['id'];
$Query1 = "select * from title where id='$id'";
...
<form name="myform" action="save_title.php" method=post onsubmit="return checkform()">
<tr bgcolor=f0f0f0><td width=80>
<strong>网站标题：</strong></td><td><textarea name="name" style="width:300;height:100" ><?echo $r1['title']?></textarea> 必填
</td></tr>
