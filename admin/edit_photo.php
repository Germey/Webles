...
<?
$id=$_GET['id'];
$Query1 = "select * from photo where id='$id'";
...
<form name="myform" action="save_photo.php" method=post onSubmit="return CheckForm();">

<tr bgcolor=f0f0f0><td align=right width=80><strong>图片标题：</strong></td><td><input name="title" style="width:300" value="<?echo $r1['title']?>">
</td></tr>
