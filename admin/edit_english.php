...
<tr><td width=30><img src=images/admin_top_close.gif></td><td style="font-weight:800;color:white"> 编辑院长信箱</td></tr>
</table>
...
<strong>院长信箱：</strong></td><td><input name="name" style="width:300" value=<?echo $r1['url']?>> 必填
</td></tr>
...
<input
  name="Add" type="submit"  id="Add" value=" 保&nbsp;&nbsp;存" style="cursor: hand;background-color: #cccccc;">
      &nbsp;&nbsp; 
      <input name="Cancel" type="button" id="Cancel" value=" 取&nbsp;&nbsp;消 " onclick="javascript:window.location='english_edit.php'" style="cursor: hand;background-color: #cccccc;">
