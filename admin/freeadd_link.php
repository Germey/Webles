...
<tr><td width=30><img src=images/admin_top_close.gif></td><td style="font-weight:800;color:white"> 添加链接</td></tr>
</table>

<table bgcolor=dddddd cellpadding=5 cellspacing=1 width=100%>
<form name="myform" action="add_link.php" method=post onSubmit="return CheckForm();">
<tr bgcolor=f0f0f0>
...
<tr bgcolor=f0f0f0><td align=right><strong>链接名称：</strong></td><td><input name="linkname" style="width:200"> 必填</td></tr>
<tr bgcolor=f0f0f0><td align=right><strong>链接地址：</strong></td><td><input name="linkurl" style="width:200"> 必填</td></tr>
<tr bgcolor=f0f0f0><td align=right><strong>图片地址：</strong></td><td><input name="imgurl" style="width:200">&nbsp;<input type="button" value="上传图片" onclick="pic()"></td></tr>
