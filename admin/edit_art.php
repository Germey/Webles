...
<tr><td width=30><img src=images/admin_top_close.gif></td><td style="font-weight:800;color:white"> 修改文章</td></tr>
</table>

<table bgcolor=dddddd cellpadding=5 cellspacing=1 width=100%>
<form name="myform" action="save_art.php" method=post onSubmit="return CheckForm();">
...
<?
$id=$_GET['articleid'];
$Query1 = "select * from article as a inner join articleclass as c on a.classid=c.classid where a.articleid='$id'";
...
<tr bgcolor=f0f0f0><td align=right><strong>文章标题：</strong></td><td><input name="title" style="width:400px" value="<?echo $r1["title"];?>">
 必填

</td></tr>
<tr bgcolor=f0f0f0><td align=right><strong>文章作者：</strong></td><td><input name="writer" style="width:200px" value="<?echo $r1["writer"];?>"></td></tr>
<tr bgcolor=f0f0f0><td align=right><strong>文章来源：</strong></td><td><input name="source" style="width:200px" value="<?echo $r1["source"];?>"></td></tr>
<tr bgcolor=f0f0f0><td align=right><strong>添加时间：</strong></td><td><input name="adddate" value="<?echo $r1["adddate"];?>" style="width:200"></td></tr>
<tr bgcolor=f0f0f0><td align=right><strong>外部链接：</strong></td><td><input name="urllink" style="width:400" value="<?echo $r1["urllink"];?>"> <input type="button" onclick="getfile1()" value="上传文件"> 当文章为外部链接时填写</td></tr>
<tr bgcolor=f0f0f0>
...
<script id="editor" type="text/plain" style="width:900px;height:300px;"><?echo $r1["content"];?></script>
<textarea name="content" id="content" style="width:800px;height:200px;display:none"></textarea>
</td>
</tr>
<tr bgcolor=f0f0f0><td align=right><strong>文章排序：</strong></td><td><input name="paixu" style="width:60px"  value="<?echo $r1["paixu"];?>"></td></tr>
          <tr bgcolor=f0f0f0> 
            <td width="100" align="right"><strong>包含图片：</strong></td>
            <td colspan="2"><input name="IncludePic" type="checkbox" id="IncludePic" value="1" style="border: 0px;background-color: #eeeeee;" <?if($r1["ispic"]==1){?>checked<?}?>>
              是<font color="#0066cc">（如果选中的话会在标题前面显示[图文]）</font></td>
          </tr>
          <tr bgcolor=f0f0f0> 
            <td width="100" align="right"><strong>文章属性：</strong></td>
            <td colspan="2"><input name="istop" type="checkbox" id="istop" value="1" style="border: 0px;background-color: #eeeeee;" <?if($r1["istop"]==1){?>checked<?}?>>
              固顶&nbsp;&nbsp;<input name="ishot" type="checkbox" id="ishot" value="1" style="border: 0px;background-color: #eeeeee;" <?if($r1["ishot"]==1){?>checked<?}?>>
              热点&nbsp;&nbsp;<input name="isrec" type="checkbox" id="isrec" value="1" style="border: 0px;background-color: #eeeeee;" <?if($r1["isrec"]==1){?>checked<?}?>>
              推荐</td>
          </tr>
<tr bgcolor=f0f0f0> 
            <td width="100" align="right"><strong>首页图片：</strong></td>
            <td colspan="2"><input name="DefaultPicUrl" type="text" id="DefaultPicUrl" size="56" maxlength="200" value="<?echo $r1["defaultpic"];?>">  <input type="button" onclick="getpic()" value="上传图片">
            </td>
          </tr>

<input type="hidden" name="id" value="<?echo $r1["articleid"];?>">
