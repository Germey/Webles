...
<td background=images/topbar_bg.gif>网站标题</td>
...
<a href="edit_title.php?id=<?echo $r["id"];?>">修改</a>&nbsp;&nbsp;

<a href="del_title.php?id=<?echo $r["id"];?>" onclick='{if(confirm("您确定删除吗?此操作将不能恢复!")){return true;}return false;}'>删除</a>
