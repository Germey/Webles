...
<td background=images/topbar_bg.gif>院长信箱</td>
...
<a href="edit_english.php?id=<?echo $r["id"];?>">修改</a>&nbsp;&nbsp;

<a href="del_english.php?id=<?echo $r["id"];?>" onclick='{if(confirm("您确定删除吗?此操作将不能恢复!")){return true;}return false;}'>删除</a>
