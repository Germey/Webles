...
<tr><td width=30><img src=images/admin_top_close.gif></td><td style="font-weight:800;color:white"> 添加浮动图标</td></tr>
</table>
...
<tr bgcolor=f0f0f0><td align=right><strong>图片地址：</strong></td><td><input name="imgurl" style="width:300">
<input type="button" value="上传图片" onclick="javascript:pic()">
</td></tr>
<tr bgcolor=f0f0f0><td align=right><strong>链接地址：</strong></td><td><input name="linkurl" style="width:300">
</td></tr>
<tr bgcolor=f0f0f0><td align=right width=80><strong>显示位置：</strong></td><td>
<input type="radio" name="position" value=0 checked> 满屏跑&nbsp;&nbsp;<input type="radio" name="position" value=1> 左侧&nbsp;&nbsp;<input type="radio" name="position" value=2> 右侧
</td></tr>
<tr bgcolor=f0f0f0><td align=right width=80><strong>显示状态：</strong></td><td>
<input type="radio" name="pass" value=1 checked> 开通&nbsp;&nbsp;<input type="radio" name="pass" value=0> 关闭

</td></tr>
<tr bgcolor=f0f0f0><td align=right><strong>显示顺序：</strong></td><td><input name="paixu" style="width:60" value="0">
</td></tr>
<tr bgcolor=f0f0f0>
<td></td>
<td>
